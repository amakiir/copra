...
class Client:
    ...
    async def products(self):
        ...
        The min_market_funds and max_market_funds fields define the min and
        max funds allowed in a market order.
        ...
        (i.e. if the increment is 0.01, order prices of 0.001 or 0.021 would be rejected).
        ...
        limit_only can be true at once. If none are true, the product is trading normally.

        fx_stablecoin indicates whether the currency pair is a Stable Pair.

        auction_mode boolean which indicates whether or not the book is in auction mode.
        For more details on the auction mode see the documentation section describing
        the level 1 book which contains information pertaining to products in auction mode.
